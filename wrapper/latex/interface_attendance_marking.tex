...
\subsubsection[{add\-Attendance\-Marking\-:}]{\setlength{\rightskip}{0pt plus 5cm}+ (void) {\bf add\-Attendance\-Marking\-:} 
\begin{DoxyParamCaption}
\item[{dummy({\bf \-Attendance\-Marking}$\ast$)}]{attendance\-Marking}
...
\subsubsection[{attendance\-Markings\-Count}]{\setlength{\rightskip}{0pt plus 5cm}+ (\-N\-S\-Integer) {\bf attendance\-Markings\-Count} 
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{attendance\-Marking\-With\-Id\-:}]{\setlength{\rightskip}{0pt plus 5cm}+ ({\bf \-Attendance\-Marking} $\ast$) {\bf attendance\-Marking\-With\-Id\-:} 
\begin{DoxyParamCaption}
\item[{dummy(\-N\-S\-Number$\ast$)}]{attendance\-Marking\-Id}
\end{DoxyParamCaption}
...
\subsubsection[{attendance\-Marking\-With\-Index\-:}]{\setlength{\rightskip}{0pt plus 5cm}+ ({\bf \-Attendance\-Marking} $\ast$) {\bf attendance\-Marking\-With\-Index\-:} 
\begin{DoxyParamCaption}
...
\subsubsection[{clear\-Attendance\-Markings}]{\setlength{\rightskip}{0pt plus 5cm}+ (void) {\bf clear\-Attendance\-Markings} 
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{id\-To\-Index\-:}]{\setlength{\rightskip}{0pt plus 5cm}+ (\-N\-S\-Integer) {\bf id\-To\-Index\-:} 
\begin{DoxyParamCaption}
\item[{dummy(\-N\-S\-Number$\ast$)}]{attendance\-Marking\-Id}
\end{DoxyParamCaption}
...
\subsubsection[{abbrev}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (\-N\-S\-String$\ast$) {\bf abbrev}\hspace{0.3cm}{\ttfamily  \mbox{[}read, write, assign\mbox{]}}}}\label{interface_attendance_marking_af637cdd49ba462876b3fe6e6957049fc}
...
\subsubsection[{attendance\-Marking\-Id}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (\-N\-S\-Number$\ast$) {\bf attendance\-Marking\-Id}\hspace{0.3cm}{\ttfamily  \mbox{[}read, write, assign\mbox{]}}}}\label{interface_attendance_marking_a211012d0e662142f3b002b57f133b0db}
...
\subsubsection[{name}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (\-N\-S\-String$\ast$) {\bf name}\hspace{0.3cm}{\ttfamily  \mbox{[}read, write, assign\mbox{]}}}}\label{interface_attendance_marking_a235155acb5a8b489b9829a09b6ac4b93}
